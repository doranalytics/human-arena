    ...
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#faf9f5", padding: 72, fontFamily: "Georgia, 'Times New Roman', serif", color: "#141413" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
          <div style={{ width: 22, height: 22, borderRadius: 999, background: "#d97757" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
          ...
          <div style={{ fontSize: 32, lineHeight: 1.3, color: "#5e5d59", fontFamily: "Helvetica, Arial, sans-serif", maxWidth: 940 }}>32 timed challenges inside a chat that watches what you click. Nothing here is real, so click anything.</div>
        </div>
