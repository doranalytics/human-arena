import { MessageSquare, Ruler, MessageCircleQuestion, RefreshCw, CheckCircle2, Users, Scale, Drama, Lightbulb, Columns3, GraduationCap, PenLine, Mail, FileText, Pickaxe, Paperclip, FileType, Camera, ScanText, Monitor, Languages, Link, Mic, AudioLines, Globe, Telescope, Cable, Workflow, Clock, Bot, FolderCog, Puzzle, Hammer, Image, Wand2, LayoutTemplate, BarChart3, GitBranch, Palette, Download, Calendar, QrCode, Folders, ClipboardList, Tag, Brain, SlidersHorizontal, Zap, ListChecks, Award, Pin, Upload, type LucideIcon } from "lucide-react";

/** One icon per skill. Icons, not emojis: the whole product uses this set. */
const ICONS: Record<string, LucideIcon> = {
  chat: MessageSquare, constraints: Ruler, interviewing: MessageCircleQuestion, iteration: RefreshCw, verification: CheckCircle2, audience: Users, steelman: Scale, roleplay: Drama, brainstorming: Lightbulb, comparisons: Columns3, tutoring: GraduationCap, "style-training": PenLine, drafting: Mail, summarizing: FileText, extraction: Pickaxe,
  ...
  projects: Folders, "custom-instructions": ClipboardList, personalization: Tag, memory: Brain, "model-choice": SlidersHorizontal, skills: Zap, "ask-user": ListChecks, organise: Pin, export: Upload,
};
