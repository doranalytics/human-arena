...
Then give it **one rule** of your choosing and have it pick the **best three**.`,
  ...
  },
  {
    slug: "pull-the-table",
    order: 15,
    title: "Messy notes to a table",
    hook: "AI turns messy notes into a clean table.",
    teaches: "Data extraction from a file: name the columns you want",
    badges: ["extraction", "file-upload"],
    minutes: 6,
    points: 55,
    brief: `**Attach the expense notes** and ask for a **clean table, one row per expense, with a total**.`,
  ...
  },
  {
    slug: "picture-math",
    order: 19,
    title: "Numbers from a screenshot",
    hook: "AI can pull numbers from a picture and add them.",
...
Ask the assistant to find your **newest unread email** and **draft a short reply** to it.`,
  ...
  },
  {
    ...
    order: 27,
    title: "Use a skill",
    hook: "A slash command runs saved instructions.",
...
Fix any words it misheard before you send.`,
  ...
  },
  {
    ...
    order: 33,
    title: "Hand it off",
    hook: "Cowork takes a task and works through the steps.",
...
Then say: **"Read my newest unread email and pull the numbers it asks for from the warehouse."** Watch it work.`,
    ...
    checks: [{ id: "numbers", label: "The reply reports the numbers requested in the newest unread email, using matching warehouse data" }],
  ...
  },
  {
    slug: "chain-it",
    order: 37,
    title: "Search, summarize, email",
    hook: "Search, summarize, and email in one conversation.",
    teaches: "Chaining: search, summarise, then send through a connector",
    badges: ["web-search", "summarizing", "connectors"],
    minutes: 7,
    points: 60,
    brief: `Connect **Gmail**. Turn on **web search** and ask for **three recent news stories about electric bikes**. Then ask for a **three-line summary**. Then ask it to **email that summary to yourself**.`,
    deliverable: "Search, then a summary, then an email sent.",
    behaviors: [
      { id: "search", label: "Turned on web search", event: "web_search_on" },
      { id: "sent", label: "Sent the summary by email", event: "email_sent" },
    ],
    checks: [{ id: "summary", label: "Three recent electric-bike stories were summarized in three lines and emailed to you" }],
    hints: [{ text: "Three messages: the search, 'summarise that in three lines', 'email it to me'." }],
  },
  {
    slug: "search-off",
    order: 38,
...
Open **Scheduled**, press **Run now**, and wait for the reply.`,
  ...
  },
  {
    ...
    order: 46,
    title: "Save a task as a skill",
    hook: "Save a completed task as a reusable command.",
    teaches: "Skills from Cowork: save a task as a slash command",
    badges: ["skills", "cowork"],
    minutes: 4,
    points: 40,
    brief: `Run any task in **Cowork**. In that thread, after the reply finishes, use **Save as skill** in the top bar. Then type its **/name** in a new chat.`,
    deliverable: "A skill made from a Cowork task, and used once.",
    behaviors: [
      { id: "saved", label: "Saved a Cowork task as a skill", event: "skill_from_cowork" },
      { id: "used", label: "Invoked it with /", event: "skill_invoked" },
    ],
    checks: [],
    hints: [{ text: "Run any Cowork task first. Save as skill appears next to Add to project." }],
  },
  {
    slug: "groups",
    order: 47,
