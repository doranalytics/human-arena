...
export const CHALLENGES: ChallengeDef[] = [
  /* ------------------------------------------------------------ prompting moves */
  {
    ...
    order: 1,
    title: "Constraints",
    hook: "Tell AI the length and it obeys exactly.",
...
Then give it **one rule** of your choosing and have it pick the **best three**.`,
  ...
  },
  {
    ...
    order: 10,
    title: "Sound human",
    hook: "One instruction makes AI writing sound human.",
...
https://en.wikipedia.org/wiki/Ultralight_backpacking`,
  ...
  /* ------------------------------------------------------------ tools and setup */
  {
    ...
    hook: "Hard questions deserve the bigger model.",
    ...
    behaviors: [{ id: "smart", label: "Selected the Smart model", event: "model_selected", detail: "smart" }],
...
Then say: **"Read my newest unread email and pull the numbers it asks for from the warehouse."** Watch it work.`,
    ...
    checks: [{ id: "numbers", label: "The reply includes numbers pulled from the warehouse" }],
  ...
  },
  {
    ...
    behaviors: [{ id: "sent", label: "Sent a message", event: "message_sent" }],
    checks: [{ id: "one", label: "The reply is one paragraph that keeps the main points" }],
  ...
  },
  {
    ...
    order: 37,
    title: "Chain it",
    hook: "You can string research, a summary and a send into one thread.",
    ...
    checks: [{ id: "summary", label: "A three-line summary of the stories was produced" }],
  ...
  },
  {
    ...
    order: 38,
    title: "Search off",
    hook: "Not every question needs the web. Off is faster and cleaner.",
    ...
    behaviors: [{ id: "sent", label: "Sent a message", event: "message_sent" }],
    checks: [{ id: "no-search", label: "A limerick, and no web search was used" }],
  ...
  },
  {
    ...
    minutes: 4,
    points: 35,
    brief: `In the + menu, turn **Memory off** for this chat. Then ask **"what do you remember about me?"** It should say nothing.`,
    deliverable: "A chat that does not use your memories.",
    behaviors: [{ id: "off", label: "Turned memory off for the chat", event: "memory_off" }],
    checks: [{ id: "blank", label: "The assistant reports no remembered facts" }],
  ...
  },
  {
    ...
    minutes: 3,
    points: 25,
    brief: `**Pin** this chat and **rename** it to "Keep". Both are on the chat's row in the sidebar.`,
    ...
    checks: [],
    hints: [{ text: "Hover the chat in the sidebar. The pin and the pencil appear on the right." }],
  },
  {
    slug: "add-to-project",
    order: 41,
  ...
  },
  {
    ...
    order: 43,
    title: "Browse skills",
    hook: "Skills come ready-made. You can add them from a catalogue.",
    teaches: "Skills: find one in the catalogue and add it",
    badges: ["skills"],
    minutes: 3,
    points: 25,
    brief: `Open **Customize**, then **Skills**, then **Browse**. Add any skill from the catalogue, then use it in this chat.`,
  ...
  },
  {
    ...
    order: 45,
    title: "Schedule it",
    hook: "Cowork can run a task on a schedule and show you each run.",
    teaches: "Automations: schedule a Cowork task",
    badges: ["automations", "cowork"],
    minutes: 5,
    points: 50,
    brief: `Switch to **Cowork**. Type a task, for example **"find three new electric bike deals"**, then use **Schedule** to run it daily. Open **Scheduled** in the sidebar and press **Run now**.`,
  ...
  },
  {
    ...
    order: 46,
    title: "Cowork to skill",
    hook: "A task you handed off can become a command you keep.",
    teaches: "Skills from Cowork: save a task as a slash command",
    badges: ["skills", "cowork"],
    minutes: 4,
    points: 40,
    brief: `In a **Cowork** thread that has run, use **Save as skill** in the top bar. Then type its **/name** in a new chat.`,
  ...
  },
  {
    ...
    minutes: 3,
    points: 25,
    brief: `From this chat's row in the sidebar, choose **Move to group**, make a group called **"Trips"**, and move the chat into it.`,
    deliverable: "A chat inside a group you made.",
    behaviors: [{ id: "grouped", label: "Moved a chat into a group", event: "chat_grouped" }],
    checks: [],
    hints: [{ text: "Hover the chat row; the folder icon is Move to group." }],
  },
];
