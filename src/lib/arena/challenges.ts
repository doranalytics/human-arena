...
export const CHALLENGES: ChallengeDef[] = [
  /* ------------------------------------------------------------ prompting moves */
  {
    ...
    order: 1,
    title: "Ten words",
    hook: "AI can compress any subject to any length you name.",
  ...
  },
  {
    ...
    hook: "AI can critique and improve its own work when you ask.",
...
Then ask the assistant to **grade its own draft** and **rewrite it** to fix what it marked down.`,
  ...
  },
  {
    ...
    hook: "AI can explain the same thing at any level you name, from five-year-old to PhD.",
  ...
  },
  {
    ...
    hook: "AI can argue the case against you as hard as you tell it to.",
...
Tell the assistant you believe it, then make it **argue the opposite as hard as it can**. No balance, no both-sides.`,
  ...
  },
  {
    ...
    order: 6,
    title: "Rehearsal",
    hook: "AI can play any person you need to practise on, then coach you.",
...
Then tell it to **break character** and give you feedback on how you did.`,
  ...
  },
  {
    ...
    hook: "AI can generate options in bulk, then judge them by your rule.",
...
Then give it **one rule** of your choosing and have it pick the **best three**.`,
  ...
  },
  {
    ...
    order: 8,
    title: "Side by side",
    hook: "AI can lay any decision out as a table and commit to a pick.",
  ...
  },
  {
    ...
    order: 9,
    title: "Tutor mode",
    hook: "AI can teach you by quizzing instead of lecturing.",
  ...
  },
  {
    ...
    order: 10,
    title: "Deslop",
    hook: "AI writing can be made to sound human with one instruction.",
  ...
  },
  {
    ...
    hook: "AI can write in your voice from two samples of it.",
  ...
  },
  {
    ...
    order: 12,
    title: "Reply to this",
    hook: "AI can draft any reply once you give it the message and the outcome.",
  ...
  },
  {
    ...
    hook: "AI can translate anything, and a round trip shows what was lost.",
  ...
  /* ------------------------------------------------------------ files and images */
  {
    ...
    order: 14,
    title: "One page",
    hook: "AI can read a long document and give you only what you need from it.",
  ...
  },
  {
    ...
    hook: "AI can turn messy notes into clean, structured data.",
  ...
  },
  {
    ...
    order: 16,
    title: "Read the PDF",
    hook: "AI can read PDFs and answer questions from them.",
  ...
  },
  {
    ...
    hook: "AI can read handwriting and screenshots and turn them into text.",
  ...
  },
  {
    ...
    order: 19,
    title: "Picture math",
    hook: "AI can pull numbers out of a picture and do the maths.",
  ...
  /* ------------------------------------------------------------ search and research */
  {
    ...
    order: 20,
    title: "Fresh news",
    hook: "AI can search the live web when you turn search on.",
  ...
  },
  {
    ...
    order: 21,
    title: "Check it",
    hook: "AI can fact-check its own answer against the web when asked.",
...
Then turn web search **on** and tell the assistant to **verify its previous answer** and list anything it got wrong or was unsure about.`,
  ...
  },
  {
    ...
    order: 22,
    title: "Deep dive",
    hook: "AI can run a full research pass and write a cited report.",
...
You want a proper report with sources, not a quick answer.`,
  ...
  },
  {
    ...
    order: 23,
    title: "Read the link",
    hook: "AI can read any web page you paste a link to.",
...
https://en.wikipedia.org/wiki/Ultralight_backpacking`,
  ...
  /* ------------------------------------------------------------ tools and setup */
  {
    ...
    hook: "You can choose how much thinking a question gets.",
  ...
  },
  {
    ...
    hook: "AI can answer from your company's data once it is connected.",
...
Ask for the company's **revenue in the most recent month on record**.`,
  ...
  },
  {
    ...
    hook: "AI can work your inbox: find the email, draft the reply.",
...
Ask the assistant to find your **newest unread email** and **draft a short reply** to it.`,
  ...
  },
  {
    ...
    order: 27,
    title: "Skill up",
    hook: "Saved instructions run with one slash command.",
...
Type **/meeting-notes** and ask for notes on that transcript. The skill sets the format; you should not have to describe it.`,
  ...
  },
  {
    ...
    order: 28,
    title: "Make a skill",
    hook: "You can turn any repeated request into your own command.",
...
Then run it on the paragraph.`,
  ...
  },
  {
    ...
    order: 29,
    title: "Set up shop",
    hook: "A project holds standing instructions for every chat inside it.",
...
Start a chat **inside the project** and ask it anything. Do not mention the rule in the chat.`,
  ...
  },
  {
    ...
    order: 30,
    title: "Call me",
    hook: "You can set rules once that every chat follows.",
...
Start a **new chat** and ask anything.`,
  ...
  },
  {
    ...
    order: 31,
    title: "Remember this",
    hook: "AI can remember facts across chats when you tell it to.",
...
Then start a **new chat** and ask **"which trail do I like best?"** It should know.`,
  ...
  },
  {
    ...
    hook: "You can talk to AI instead of typing.",
...
Fix any words it misheard before you send.`,
  ...
  },
  {
    ...
    order: 33,
    title: "Hand it off",
    hook: "AI can take a multi-step task and work through it on its own.",
